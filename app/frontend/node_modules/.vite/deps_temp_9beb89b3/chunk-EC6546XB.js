...
var NativeInteractionClient = class extends BaseInteractionClient {
  ...
  async generateAuthenticationResult(response, request, idTokenClaims, accountEntity, authority, reqTimestamp) {
    ...
    const fullAccountEntity = idTokenClaims ? Object.assign(new AccountEntity(), {
      ...accountEntity,
      idTokenClaims
    }) : accountEntity;
...
var PopupClient = class extends StandardInteractionClient {
  ...
  async acquireTokenPopupAsync(request, popupName, popupWindowAttributes, popup) {
    ...
    try {
      ...
      const result = await interactionHandler.handleCodeResponseFromHash(hash, validRequest);
      return result;
    } catch (e) {
      if (popup) {
        popup.close();
  ...
  extractServerResponseStringFromPopup(popupWindow, href) {
    ...
    if (((_a = this.config.auth.OIDCOptions) == null ? void 0 : _a.serverResponseType) === ServerResponseType.QUERY) {
...
async function monitorIframeForHash(iframe, timeout, pollIntervalMilliseconds, performanceClient, logger, correlationId) {
  ...
  return new Promise((resolve, reject) => {
    ...
    const intervalId = window.setInterval(() => {
      ...
      const contentHash = contentWindow ? contentWindow.location.hash : "";
...
var StandardController = class _StandardController {
  ...
  constructor(operatingContext) {
    this.atsAsyncMeasurement = void 0;
  ...
  async handleRedirectPromise(hash) {
    ...
    if (this.isBrowserEnvironment) {
      ...
      if (typeof response === "undefined") {
        ...
        if (request && NativeMessageHandler.isNativeAvailable(this.config, this.logger, this.nativeExtensionProvider) && this.nativeExtensionProvider && !foundServerResponse) {
          ...
          redirectResponse = redirectClient.handleRedirectPromise(foundServerResponse);
        }
  ...
  getNativeAccountId(request) {
    const account = request.account || this.browserStorage.getAccountInfoFilteredBy({
  ...
  async acquireTokenSilentAsync(request, account) {
    ...
    (_a = this.atsAsyncMeasurement) == null ? void 0 : _a.increment({
      visibilityChangeCount: 0
    });
    ...
    if (NativeMessageHandler.isNativeAvailable(this.config, this.logger, this.nativeExtensionProvider, request.authenticationScheme) && account.nativeAccountId) {
      ...
      result = invokeAsync(this.acquireTokenFromCache.bind(this), PerformanceEvents.AcquireTokenFromCache, this.logger, this.performanceClient, silentRequest.correlationId)(silentCacheClient, silentRequest, cacheLookupPolicy).catch((cacheError) => {
        ...
        return invokeAsync(this.acquireTokenByRefreshToken.bind(this), PerformanceEvents.AcquireTokenByRefreshToken, this.logger, this.performanceClient, silentRequest.correlationId)(silentRequest, cacheLookupPolicy).catch((refreshTokenError) => {
          const isSilentlyResolvable = !(refreshTokenError instanceof InteractionRequiredAuthError) && (refreshTokenError.errorCode === BrowserConstants.INVALID_GRANT_ERROR || refreshTokenError.errorCode === ClientAuthErrorCodes_exports.tokenRefreshRequired) || refreshTokenError.errorCode === InteractionRequiredAuthErrorCodes_exports.noTokensFound;
          const tryIframeRenewal = cacheLookupPolicy === CacheLookupPolicy.Default || cacheLookupPolicy === CacheLookupPolicy.Skip || cacheLookupPolicy === CacheLookupPolicy.RefreshTokenAndNetwork;
    ...
    return result.then((response) => {
      ...
      (_a2 = this.atsAsyncMeasurement) == null ? void 0 : _a2.end({
        success: true,
        fromCache: response.fromCache,
        isNativeBroker: response.fromNativeBroker,
        requestId: response.requestId
...
@azure/msal-browser/dist/controllers/StandardController.mjs:
  (*! @azure/msal-browser v3.4.0 2023-10-30 *)
*/
//# sourceMappingURL=chunk-EC6546XB.js.map
