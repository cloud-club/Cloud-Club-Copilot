...
var BaseOperatingContext = class {
  constructor(config) {
...
var BridgeProxy = class _BridgeProxy {
  ...
  getAccountInfo(request) {
    ...
    if (request.homeAccountId !== void 0) {
      method = "GetAccountByHomeId";
    }
    if (request.localAccountId !== void 0) {
      method = "GetAccountByLocalId";
    }
    if (request.username !== void 0) {
      method = "GetAccountByUsername";
    }
    return this.sendRequest(method, request);
  }
  getActiveAccount() {
    return this.sendRequest("GetActiveAccount", void 0);
  }
  /**
  ...
  sendRequest(method, request) {
    ...
    const promise = new Promise((resolve, reject) => {
      ...
      _BridgeProxy.bridgeRequests.push(request2);
      window.nestedAppAuthBridge.postMessage(JSON.stringify(message));
    });
    return promise;
  }
...
async function createV3Controller(config) {
  ...
  const controller = await import("./StandardController-J72XCU6L.js");
...
async function createController(config) {
  ...
  if (teamsApp.isAvailable() && teamsApp.getConfig().auth.supportsNestedAppAuth) {
    const controller = await import("./NestedAppAuthController-LSMQ3PLN.js");
...
@azure/msal-browser/dist/index.mjs:
  (*! @azure/msal-browser v3.4.0 2023-10-30 *)
*/
//# sourceMappingURL=chunk-WQEF5RDN.js.map
