...
var AccountEntity = class _AccountEntity {
  ...
  static generateHomeAccountId(serverClientInfo, authType, logger, cryptoObj, idTokenClaims) {
    const accountId = (idTokenClaims == null ? void 0 : idTokenClaims.sub) ? idTokenClaims.sub : Constants.EMPTY_STRING;
...
var UrlString = class _UrlString {
   ...
   */
  getHash() {
    return _UrlString.parseHash(this.urlString);
  }
  /**
  ...
  static getDeserializedHash(hash) {
    ...
    const parsedHash = _UrlString.parseHash(hash);
  ...
  static getDeserializedQueryString(query) {
    ...
    const parsedQueryString = _UrlString.parseQueryString(query);
  ...
  static getDeserializedCodeResponse(serverResponseType, hashFragment) {
    const hashUrlString = new _UrlString(hashFragment);
    let serverParams;
    if (serverResponseType === ServerResponseType.QUERY) {
      serverParams = _UrlString.getDeserializedQueryString(hashFragment);
    } else {
      serverParams = _UrlString.getDeserializedHash(hashUrlString.getHash());
    }
    return serverParams;
  }
  /**
  ...
  static hashContainsKnownProperties(hash) {
    ...
    const parameters = _UrlString.getDeserializedHash(hash);
...
var TimeUtils = class _TimeUtils {
  /**
  ...
  static isTokenExpired(expiresOn, offset) {
    ...
    const offsetCurrentTimeSec = _TimeUtils.nowSeconds() + offset;
  ...
  static wasClockTurnedBack(cachedAt) {
    ...
    return cachedAtSec > _TimeUtils.nowSeconds();
  }
  /**
...
var AuthorityMetadataEntity = class {
  constructor() {
...
Error Description: ${typedError.message}`);
  ...
  static replaceWithRegionalInformation(metadata, azureRegion) {
    ...
    regionalMetadata.token_endpoint = _Authority.buildRegionalAuthorityString(regionalMetadata.token_endpoint, azureRegion, Constants.REGIONAL_AUTH_NON_MSI_QUERY_STRING);
...
var CacheManager = class {
   ...
   */
  matchName(entity, name2) {
    var _a;
    return !!(name2.toLowerCase() === ((_a = entity.name) == null ? void 0 : _a.toLowerCase()));
  }
  /**
  ...
  matchLoginHint(idTokenClaims, loginHint) {
    if ((idTokenClaims == null ? void 0 : idTokenClaims.login_hint) === loginHint) {
      return true;
    }
    if (idTokenClaims.preferred_username === loginHint) {
      return true;
    }
    if ((idTokenClaims == null ? void 0 : idTokenClaims.upn) === loginHint) {
      return true;
    }
    return false;
  }
  ...
  matchSid(idTokenClaims, sid) {
    return !!((idTokenClaims == null ? void 0 : idTokenClaims.sid) && idTokenClaims.sid === sid);
  }
...
var AuthorityFactory = class _AuthorityFactory {
  /**
  ...
  static async createDiscoveredInstance(authorityUri, networkClient, cacheManager, authorityOptions, logger, performanceClient, correlationId) {
    ...
    const acquireTokenAuthority = _AuthorityFactory.createInstance(authorityUriFinal, networkClient, cacheManager, authorityOptions, logger, performanceClient, correlationId);
    try {
...
var AppMetadataEntity = class _AppMetadataEntity {
  /**
   * Generate AppMetadata Cache Key as per the schema: appmetadata-<environment>-<client_id>
   */
  generateAppMetadataKey() {
    return _AppMetadataEntity.generateAppMetadataCacheKey(this.environment, this.clientId);
  }
  /**
  ...
  static createAppMetadataEntity(clientId, environment, familyId) {
    const appMetadata = new _AppMetadataEntity();
...
${serverError}`);
    ...
    try {
      ...
      if (handlingRefreshTokenResponse && !forceCacheRefreshTokenResponse && cacheRecord.account) {
        ...
        if (!account) {
          ...
          return _ResponseHandler.generateAuthenticationResult(this.cryptoObj, authority, cacheRecord, false, request, idTokenClaims, requestStateObj, void 0, serverRequestId);
        }
      }
  ...
  generateCacheRecord(serverTokenResponse, authority, reqTimestamp, request, idTokenClaims, userAssertionHash, authCodePayload) {
    ...
    if (serverTokenResponse.access_token) {
      ...
      cachedAccessToken = createAccessTokenEntity(this.homeAccountIdentifier, env, serverTokenResponse.access_token, this.clientId, (idTokenClaims == null ? void 0 : idTokenClaims.tid) || authority.tenant, responseScopes.printScopes(), tokenExpirationSeconds, extendedTokenExpirationSeconds, this.cryptoObj.base64Decode, refreshOnSeconds, serverTokenResponse.token_type, userAssertionHash, serverTokenResponse.key_id, request.claims, request.requestedClaimsHash);
    }
  ...
  static async generateAuthenticationResult(cryptoObj, authority, cacheRecord, fromTokenCache, request, idTokenClaims, requestState, serverTokenResponse, requestId) {
    ...
    return {
      ...
      account: accountInfo,
      idToken: ((_a = cacheRecord == null ? void 0 : cacheRecord.idToken) == null ? void 0 : _a.secret) || "",
      ...
      familyId,
      tokenType: ((_b = cacheRecord.accessToken) == null ? void 0 : _b.tokenType) || Constants.EMPTY_STRING,
      state: requestState ? requestState.userRequestState : Constants.EMPTY_STRING,
      cloudGraphHostName: ((_c = cacheRecord.account) == null ? void 0 : _c.cloudGraphHostName) || Constants.EMPTY_STRING,
      msGraphHost: ((_d = cacheRecord.account) == null ? void 0 : _d.msGraphHost) || Constants.EMPTY_STRING,
...
var AuthorizationCodeClient = class extends BaseClient {
  ...
  handleFragmentResponse(hashFragment, cachedState) {
    ...
    const serverParams = UrlString.getDeserializedCodeResponse((_a = this.config.authOptions.authority.options.OIDCOptions) == null ? void 0 : _a.serverResponseType, hashFragment);
  ...
  async createTokenRequestBody(request) {
    ...
    const parameterBuilder = new RequestParameterBuilder();
    parameterBuilder.addClientId(((_b = request.tokenBodyParameters) == null ? void 0 : _b[AADServerParamKeys.CLIENT_ID]) || this.config.authOptions.clientId);
  ...
  async createAuthCodeUrlQueryString(request) {
    ...
    const parameterBuilder = new RequestParameterBuilder();
    parameterBuilder.addClientId(((_b = request.extraQueryParameters) == null ? void 0 : _b[AADServerParamKeys.CLIENT_ID]) || this.config.authOptions.clientId);
    const requestScopes = [
      ...request.scopes || [],
...
var ServerTelemetryEntity = class {
  constructor() {
    this.failedRequests = [];
    this.errors = [];
    this.cacheHits = 0;
...
var PerformanceClient = class {
  ...
  endMeasurement(event, measurement) {
    ...
    measurement == null ? void 0 : measurement.endMeasurement();
    const durationMs = measurement == null ? void 0 : measurement.flushMeasurement();
    if (!durationMs) {
...
@azure/msal-common/dist/cache/entities/AuthorityMetadataEntity.mjs:
  (*! @azure/msal-common v14.3.0 2023-10-30 *)
...
@azure/msal-common/dist/cache/entities/AppMetadataEntity.mjs:
  (*! @azure/msal-common v14.3.0 2023-10-30 *)
...
@azure/msal-common/dist/cache/entities/ServerTelemetryEntity.mjs:
  (*! @azure/msal-common v14.3.0 2023-10-30 *)

@azure/msal-common/dist/cache/entities/ThrottlingEntity.mjs:
  (*! @azure/msal-common v14.3.0 2023-10-30 *)
...
@azure/msal-browser/dist/cache/CryptoKeyStore.mjs:
  (*! @azure/msal-browser v3.4.0 2023-10-30 *)
...
@azure/msal-browser/dist/event/EventHandler.mjs:
  (*! @azure/msal-browser v3.4.0 2023-10-30 *)
*/
//# sourceMappingURL=chunk-RVX2U4VA.js.map
